...
df$ideology[df$ideology %in% 1] <- "Lib"
df$ideology[df$ideology %in% 2] <- "Lib"
df$ideology[df$ideology %in% 3] <- "Moderate"
df$ideology[df$ideology %in% 4] <- "Con"
df$ideology[df$ideology %in% 5] <- "Con"
df$ideology[df$ideology %in% 6] <- "Don't know"

df$ideo_f <- factor(df$ideology,
  levels = c("Lib", "Moderate", "Con", "Don't know")
)

df$ideo_con <- ifelse(df$ideo_f == "Con", 1, 0)
df$ideo_lib <- ifelse(df$ideo_f == "Lib", 1, 0)
